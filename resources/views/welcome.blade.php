...
<body>
                ...
                <div class="container box2">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <h1 class="display-2 text-center text-azzurro1 titolo1">{{$titolo}}</h1>
                            {{-- <h2 class="text-center text-arancio titolo2">Storia, lore e segreti dell’universo Halo</h2> --}}
                            <h2 class="text-center text-arancio titolo2">{{$titolo2}}</h2>
    ...
    <section class="container-fluid azzurro box3">

        <h3 class="text-center mb-5">Ultimi articoli </h3>
        ...
        <article class="row">
            ...
            {{-- immagine articolo --}}
            <div class="col-12 col-md-3 box5 d-flex justify-content-end">
                <img src="/media/article_1.jpg" alt="immagine halo" class="img-fluid">
            </div>
            ...
            <div class="col-12 col-md-3 box5">
                <h4>PRESENTAZIONE</h4>
                <h3>Master Chief</h3>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae fugit incidunt qui architecto
                    consequatur nam fugiat dolore corporis, sapiente quod ipsa, cupiditate, ea commodi odio a pariatur
                    voluptatem! Quos, architecto?</p>
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-secondary btn-custom">Val all'articolo</button>
                </div>
        ...
        <article class="row mt-5">
            ...
            {{-- immagine articolo --}}
            <div class="col-12 col-md-3 box5 d-flex justify-content-end">
                <img src="/media/article_2.jpg" alt="immagine halo combat evolved" class="img-fluid">
            </div>
        ...
        <article class="row mt-5">
            ...
            {{-- immagine articolo --}}
            <div class="col-12 col-md-3 box5 d-flex justify-content-end">
                <img src="/media/article_3.jpg" alt="immagine halo Infinite" class="img-fluid">
            </div>
